    ...
    <div className="mx-auto max-w-3xl">
      <div className="rounded-3xl bg-white p-6 shadow-sm sm:p-8">
              ...
              >
                <div>
                  ...
                  <div className="mt-1 text-xs text-slate-500">
                    {item.sku} . {item.quantity} x {formatCurrency(item.price)}
                  </div>
                </div>
        ...
        <div className="grid gap-3 border-t border-slate-100 pt-6 text-sm">
          ...
          <div className="flex justify-between"><span className="text-slate-500">Total</span><strong className="uppercase">{transaction.total}</strong></div>
          <div className="flex justify-between"><span className="text-slate-500">Dibayar</span><strong className="uppercase">{formatCurrency(transaction.paymentAmount)}</strong></div>
          <div className="flex justify-between"><span className="text-slate-500">Kembalian</span><strong className="uppercase">{formatCurrency(transaction.change)}</strong></div>
